...
<c:url value="/AlunoController?action=listUser" var="aluno"/>
<c:url value="/CursoController?action=listUser" var="curso"/>
<c:url value="/DisciplinaController?action=listUser" var="disciplina"/>
<c:url value="/ProfessorController?action=listUser" var="professor"/>
<c:url value="/TurmaController?action=listUser" var="turma"/>
...
<body>
	...
	<main>
		<form class="menu-main" action="${ aluno }" method="get">
			<li class="li-index">
		...
		<form class="menu-main" action="${ professor }" method="get">	
			<li class="li-index">
				<input type="hidden" name="action" value="Form" />
		...
		<form class="menu-main" action="${ curso }" method="get">	
			<li class="li-index">
				<input type="hidden" name="action" value="Form" />
		...
		<form class="menu-main" action="${ disciplina }" method="get">	
			<li class="li-index">
				<input type="hidden" name="action" value="Form" />
		...
		<form class="menu-main" action="${ turma }" method="get">	
			<li class="li-index">
				<input type="hidden" name="action" value="Form" />
