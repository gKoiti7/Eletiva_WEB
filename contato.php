          ...
          <form class="needs-validation" novalidate="" method="get" action="01valor.php">
            ...
            <div class="d-block my-3">
              ...
              <div class="custom-control custom-radio">
                <input id="analise" name="aval" type="radio" class="custom-control-input" checked="" required="" value="1">
                <label class="custom-control-label" for="analise">Análise e Desenvolvimento de Sistemas</label>
              </div>
			  
              <div class="custom-control custom-radio">
                <input id="agro" name="aval" type="radio" class="custom-control-input" required="" value="2">
                <label class="custom-control-label" for="agro">Agronegócio</label>
              </div>
			  
              <div class="custom-control custom-radio">
                <input id="rh" name="aval" type="radio" class="custom-control-input" required="" value="3">
                <label class="custom-control-label" for="rh">Recursos Humanos</label>
              </div>
			  
			  <div class="custom-control custom-radio">
                <input id="secretariado" name="aval" type="radio" class="custom-control-input" required="" value="4">
                <label class="custom-control-label" for="secretariado">Secretariado</label>
              </div>
			  
			  <div class="custom-control custom-radio">
                <input id="adm" name="aval" type="radio" class="custom-control-input" required="" value="5">
